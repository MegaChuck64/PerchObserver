...
{
    private readonly Dictionary<string, Models.BirdRecord> _birds = [];
    ...
    public Models.BirdRecord ProcessFeatures(string photoId, float[] features)
    {
        ...
        var newSet = new Models.FeatureSet(photoId, normalizedFeatures, bestSimilarity);
        ...
        else
        {
            ...
            var newBirdSet = new Models.FeatureSet(photoId, normalizedFeatures, 0.0f);
            var newBird = new Models.BirdRecord(newId, newBirdSet);
            _birds[newId] = newBird;
            return newBird;
        }
    }

    private static float CalculateBirdSimilarity(float[] features, Models.BirdRecord bird)
    {
